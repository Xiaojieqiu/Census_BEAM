 # save.image('HSMM_all_data.RData')
  ...
  root_directory <- "/net/trapnell/vol1/home/xqiu/Projects/BEAM/Xiaojie_reproduce/"
  ...
  abs_bifurcation_time <- detectBifurcationPoint(abs_AT12_cds_subset_all_gene_ILRs[1:transcript_num, 27:100], div_threshold = 0.3)
