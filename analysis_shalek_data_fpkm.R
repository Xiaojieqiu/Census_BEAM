...
std_ko_branching_genes = branchTest(std_Shalek_subset_ko_LPS, fullModelFormulaStr = full_model_string, cores = detectCores(), relative_expr = T, weighted = T)
closeAllConnections()
...
std_golgi_branching_genes = branchTest(std_Shalek_golgi_update, fullModelFormulaStr = full_model_string, cores= detectCores(), relative_expr = T, weighted = T)
closeAllConnections()
