  ...
  umi_matrix <- read.delim("./GSE54695_data_transcript_counts.txt", row.names="GENENAME")
  ...
  qplot(pData(UMI_cds)$dmode, log = 'x') + xlab('Mode of UMI for each cell') #confirm the first assumption
  # 
  ...
  #DESeq2/edgeR: 
  UMI_cds_76_55_deseq2_res <- DESeq2_deg(dir = NULL, UMI_cds_76_55, Time = Marker_ori, pd = pData(UMI_cds_76_55))
  ...
  ggsave(filename = "/Users/xqiu/Dropbox (Cole Trapnell's Lab)/Manuscript/AI/First reversin/Figures/figsc_UMI_GSE54695.pdf", width = 2.5, height = 2)
