...
ggsave(filename =paste(elife_directory, 'figure_5A_new.pdf', sep = ''), height = 3, width = 3)

#for making the legends: 
monocle::plot_spanning_tree(Shalek_abs_subset_ko_LPS, color_by="interaction(experiment_name, time)", cell_size=1) + 
scale_color_manual(values=shalek_custom_color_scale_plus_states) + illustrator_theme() + 
ggsave(filename =paste(elife_directory, 'figure_5A_new_helpA.pdf', sep = ''), height = 2, width = 2)

monocle::plot_spanning_tree(Shalek_abs_subset_ko_LPS, color_by="State", cell_size=1) + 
scale_color_manual(values=shalek_custom_color_scale_plus_states) + illustrator_theme() + 
ggsave(filename =paste(elife_directory, 'figure_5A_new_helpB.pdf', sep = ''), height = 2, width = 2)  
...
# ggsave(filename = paste(elife_directory, 'figure_5D_go.pdf', sep = ''), height=15, width = 7)
plot_gsa_hyper_heatmap(Shalek_abs_subset_ko_LPS, Shalek_abs_subset_ko_LPS_tree_hyper_geometric_results_reactome, significance=1e-1) + illustrator_theme() + 
ggsave(filename = paste(elife_directory, 'figure_5D_reactome.pdf', sep = ''), height=15, width = 7)
...
# ggsave(filename = paste(elife_directory, 'figure_5D_kegg.pdf', sep = ''), height=12, width = 7)
...
# ggsave(filename =paste(elife_directory, 'figure_5D_go_cc.pdf', sep = ''), height=12, width = 7)
...
# ggsave(filename =paste(elife_directory, 'figure_5D_go_mf.pdf', sep = ''), height=12, width = 7)
...
#pdf(file = paste(elife_directory, 'eLife_fig6_SI_ko_overlapping.pdf', sep = ''))
...
illustrator_theme() + geom_hline(yintercept = 1, linetype = 2, size  = 0.2, color = 'blue') + xlab('') + #geom_text(aes(label = label), angle = 45, vjust = 2) 
ggsave(paste(elife_directory, "/figure_5_enrichment.pdf", sep = ''), height = 2, width = 3)
...
scale_color_manual(values=shalek_custom_color_scale_plus_states) + illustrator_theme() +  
ggsave(filename =paste(elife_directory, 'figure_6A_new.pdf', sep = ''), height = 3, width = 3)

#help figures for adding the legend: 
monocle::plot_spanning_tree(Shalek_golgi_update, color_by="interaction(experiment_name, time)", cell_size=1) + 
scale_color_manual(values=shalek_custom_color_scale_plus_states) +# illustrator_theme2() +  
ggsave(filename =paste(elife_directory, 'figure_6A_new_helpA.pdf', sep = ''), height = 12, width = 12)
monocle::plot_spanning_tree(Shalek_golgi_update, color_by="State", cell_size=1) + 
scale_color_manual(values=shalek_custom_color_scale_plus_states) +# illustrator_theme2() +  
ggsave(filename =paste(elife_directory, 'figure_6A_new_helpB.pdf', sep = ''), height = 12, width = 12)
...
file_name=paste(elife_directory, 'figure_6C.pdf', sep = ''), cores=1, ABC_df=NULL, branchTest_df=golgi_branching_genes, hmcols=NULL)
...
ggsave(paste(elife_directory, 'figure_6D.pdf', sep = '') , height=20, width = 9)
...
plot_gsa_hyper_heatmap(Shalek_golgi_update_heatmap_annotations, Shalek_golgi_hyper_geometric_results_reactome, significance=1e-3) + illustrator_theme() + 
ggsave(paste(elife_directory, 'figure_6D_reactome.pdf', sep = '') , height=30, width = 7)
...
# ggsave(paste(elife_directory, 'figure_6D_kegg.pdf', sep = ''), height=12, width = 7)
...
# ggsave(paste(elife_directory, 'figure_6D_go_cc.pdf', sep = '') , height=12, width = 7)
...
# ggsave(paste(elife_directory, 'figure_6D_go_mf.pdf', sep = '') , height=12, width = 7)

save_hyper_df(Shalek_golgi_hyper_geometric_results_reactome, 'golgiplug_hyper_df.xls') 
# save(branch_pseudotime_element_all, branch_pseudotime_sets_all, file = 'branchTest_cmpr_subset')

# pdf(file = paste(elife_directory, 'eLife_fig_SI_branchTest_cmpr.pdf', sep = ''), height = 2, width = 3)
#pdf(file = paste(elife_directory, 'eLife_fig6_SI_blocking.pdf', sep = ''))
#venneuler_venn(andrew_element_all, andrew_sets_all)
#dev.off()
...
ggsave(paste(elife_directory, "eLife_fig6_SI_enrichment.pdf", sep = ''), height = 1.2, width = 8)
...
ggsave(paste(elife_directory, 'eLife_fig6_SI_branching_genes.pdf', sep = ''), height = 4, width = 15)
...
pdf(file = paste(elife_directory, 'eLife_fig6_golgi_branch_overlapping.pdf', sep = ''))
venneuler_venn(andrew_element_all, andrew_sets_all)
dev.off()
...
#            lineage_labels = c('Normal cells', 'GolgiPlug'), cell_size = 1, ncol = 8, reducedModelFormulaStr = "~sm.ns(Pseudotime, df=3)", add_pval = T) + 
#            ylab('Transcript counts') #+ nm_theme()
# ggsave(paste(elife_directory, 'eLife_fig6_SI_DEG_genes.pdf', sep = ''), height = 4, width = 15)
...
motif_enrich_plot_golgi + illustrator_theme() + ggsave(paste(elife_directory, "/figure_6_enrichment_heatmap.pdf", sep = ''), height = 2, width = 3)
