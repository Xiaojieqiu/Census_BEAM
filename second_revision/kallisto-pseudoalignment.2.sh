...
-o /net/trapnell/vol1/jspacker/sandberg/kallisto-pseudoalignments-2/$id  \
...
>/net/trapnell/vol1/jspacker/sandberg/kallisto-pseudoalignments-2/$id.pseudoalignment.gz
